...
const TechCard = () => {
  ...
  return (
    <>
      {/* Grid de cards */}
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-400 mx-auto mt-16 px-5 xl:px-2"
            ...
            <div className="flex justify-center items-center gap-2 px-5 pb-5 mt-auto">
              {card.technologies.map((tech, idx) => (
                <img
                  ...
                  alt={tech}
                  title={tech}
                  className="w-6 h-6 hover:scale-[1.05] cursor-pointer"
                />
              ))}
            </div>
          </motion.div>
            ...
            <div>
              {selectedCard.link && (
                <div className="flex justify-center items-center gap-4 mb-3">
                  ...
                  >
                    <span className="truncate eaes-in-out duration-300 group-active:-translate-x-96 group-focus:translate-x-96 text-sm">
                      Testar Aplicação
                    </span>
                  ...
                  <a
                    ...
                    className="cursor-pointer flex overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-black text-white shadow hover:bg-black/90 h-9 px-4 py-2 max-w-52 whitespace-pre md:flex group relative w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out hover:ring-2 hover:ring-black hover:ring-offset-2"
                  >
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-white">Explorar código</span>
                    </div>
                  </a>
                </div>
              )}
